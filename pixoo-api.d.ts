...
declare module 'pixoo-api' {
	export class PixooAPI {
		...
		drawChar: (char: string, position: Position, color: Color, font?) => undefined;
		drawText: (text: string, position: Position, color: Color, font?) => undefined;
		...
		drawRect: (start: Position, end: Position, color: Color, fill = false) => undefined;
